...
os.system("curl --insecure -o /etc/git_release.json https://api.github.com/repos/jessejamescox/project_backup/releases/latest")
with open('/etc/git_release.json') as f_gitinfo:
    git_data = json.load(f_gitinfo)
    target_version = git_data["tag_name"]

# get the current time 
mytime = strftime("%a, %d %b %Y %H:%M:%S +0000", localtime())
